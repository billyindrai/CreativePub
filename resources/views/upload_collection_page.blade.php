...
<div class="container-2xl md:flex grid grid-cols-2 px-32">
    <div class="container-2xl border-dashed border-2 w-1/2 h-80 border-white rounded-md flex justify-center items-center mt-6">
        <div class="container-2xl">
            ...
            <div class="container-2xl md:flex flex-1 justify-center">
                <div class="container-2xl w-max mr-9">
