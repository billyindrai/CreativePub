...
<div class="container-2xl md:flex justify-center items-center mx-auto px-12 space-x-12 py-5">
    ...
    <div id="defaultModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full ">
        <div class="relative container bg-zinc-800 md:flex flex-1 p-4 w-full max-w-2xl h-full ">
            <div class="container-2xl  py-3 px-16 rounded-md">
                <div class="container-2xl md:flex flex-1 mb-3 items-center">
                    ...
                    <div class="px-3.5">
                        ...
                        <p class="font-thin font-sans text-xs text-white">Tono Sucipto <strong class="font-sans text-xs font-bold text-register_orange"> Follow </strong></p>
                    </div>
                ...
                <div class="container-2xl md:flex flex-1 pb-3 border-b border-amber-200 gap-3">
                    <button class="bg-register_orange text-white rounded-md p-2 text-xs font-sans">#poster</button>
                    <button class="bg-register_orange text-white rounded-md p-2 text-xs font-sans">#cool</button>
                </div>
                <div class="container-2xl my-3">
                    <p class="font-sans text-white">Comment <sup class="font-sans text-base text-register_orange">3</sup></p>
                </div>
                @for ($i = 0; $i <= 2; $i++) 
                <div class="container-2xl md:flex flex-1 mb-3 items-center">
                    <img class="rounded-full object-cover float-left w-12 h-12" src="https://img.freepik.com/free-photo/mand-holding-cup_1258-340.jpg?size=626&ext=jpg&ga=GA1.2.1546389280.1639353600" alt="">
                ...
                <div class="container-2xl bg-content_box rounded-lg p-4">
                    ...
                    <div class="container-2xl p-3 h-20">
                        <input class=" placeholder:text-white bg-content_box rounded-md text-white px-2 w-full border-transparent h-full" type="text" placeholder="Write your comment here">
                    </div>
                    <div class="container-2xl md:flex flex-1 justify-end items-end">
                        <button class="bg-register_orange hover:bg-orange-700 text-white rounded-md p-2 text-xs font-sans">Comment</button>  
                    </div> 
                </div>
            </div>
            <div class="container-2xl w-20">
                <button type="button" class="text-register_orange bg-transparent hover:bg-orange-700 hover:text-gray-900 rounded-lg text-sm p-1.5 mx-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="defaultModal">
