...
<div class="container-2xl py-5 mx-auto">
    <div class="container-2xl md:flex flex-1 justify-center py-2 mt-5 h-fit mx-48 gap-5">
        <form class="container-2xl md:flex flex-1 gap-3 justify-center" method="GET" action="/search_posted_job">
        ...
        <!-- <div class="container-2xl md:flex flex-1 gap-5 justify-end">
            <form id="categoryBox" method="POST" action="/select_posted_job_category">
            @csrf
                <select name="categoryBox" id="categoryBox" form="categoryBox" >
                    @if(isset($category))
...
<!-- <script>
    $(document).on('change', '#categoryBox', function (e) {
    $(this).closest('#categoryBox').submit();
    });
</script> -->
@endsection