...
<div class="container-2xl md:flex flex-1 justify-center items-center">
    ...
    <div class="container-2xl py-5 ">
        ...
        @foreach($gallery as $g)
                    ...
                    <tr>
                    <td class="p-5" >{{$g->idGallery}}</td>
                    <td class="p-5" >{{$g->titleGallery}}</td>
                    <td class="p-5" >{{$g->categoryGallery}}</td>
                    <td class="p-5" >
                        <button data-modal-toggle="<?php echo htmlspecialchars($g->idGallery); ?>" class=" bg-register_orange hover:bg-orange-700 text-white rounded-md p-2 font-sans">View Content</button>
                    </td>
                    <td class="p-5" >
        ...
        @endforeach
            ...
            <div class="container-2xl text-white md:flex flex-1 mt-2 justify-center">
            {{$gallery->links()}}
            </div>
    </div>
</div>
