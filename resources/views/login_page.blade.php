...
<body class="antialiased bg-background">
    <div class="md:flex flex-1 grid grid-cols-3 gap-4">
        <div>
            <img class="w-max h-screen" src="{{ asset('images/login_photo.png') }}"></img>
        </div>
        <div class="container md:flex flex-1 justify-center items-center ml-6">
            <ul class="items-center text-base mr-12 font-sans ">
                ...
                <div class="container mt-12">
                    ...
                    <input class=" bg-white rounded-lg w-80 h-10" type="text">
                </div>
                ...
                <div class="container mt-6">
                    <button class="bg-register_orange text-white font-sans rounded-lg w-80 h-10 text-2xl font-bold">Login</button>
                </div>
                <!-- <div class="container md:flex flex mt-6 justify-center b">
                    <div class="border-2 border-l-transparent border-t-transparent border-r-transparent border-b-cream_line w- "></div>
                    <li class="text-white font-light text-center">or login with</li>
                    <div class="border-2 border-l-transparent border-t-transparent border-r-transparent border-b-cream_line "></div>
                </div> -->
                <div class="relative flex mt-6 items-center">
                    <div class="flex-grow border-t border-cream_line"></div>
                    <span class="flex-shrink mx-4 text-white font-extralight"> or login with</span>
                    <div class="flex-grow border-t border-cream_line"></div>
                </div>
                ...
                <div class="container mt-6">
                    <a class="flex justify-center" href="/forgot_password">
                        <li class="text-register_orange font-semibold cursor-pointer hover:underline">Forgot login or password</li>
                    </a>
                </div>
            </ul>
        </div>
        <div>
            <ul class="container text-base font-sans mt-6 mr-6 ">
                <a class="flex" href="/register">
                    <li class="text-white">Not a Member?</li>
                    <li class="text-register_orange cursor-pointer hover:underline">Register Now</li>
                </a>
            </ul>
        </div>
    </div>
