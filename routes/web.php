...
Route::get('/search_posted_job',[JobController::class, 'searchPostedJobs']);
Route::get('/search_job',[JobController::class, 'searchJobs']);
Route::get('/search_my_job',[JobController::class, 'searchMyJobs']);
Route::get('/search_draft_job',[JobController::class, 'searchDraftJobs']);
