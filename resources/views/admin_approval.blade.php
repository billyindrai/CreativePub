...
<div class="container-2xl md:flex flex-1 justify-center items-center">
    ...
    <div class="container-2xl py-5 ">
        ...
        @foreach($collection as $c)
                    ...
                    <td class="p-5" >
                        <form method="POST" action="/delete_approval">
                            @csrf 
                        ...
                        <form method="POST" action="/approve_collection">
                            @csrf 
                            <input type="hidden" name="collectionId" value="{{$c->idCollection}}">
                            <button class="mt-3 bg-green-500 hover:bg-green-900 text-white rounded-md p-2 font-sans">Approve</button>
                        </form>
