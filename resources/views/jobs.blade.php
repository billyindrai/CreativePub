...
<div class="container-2xl py-5 bg-zinc-700 mx-auto">
    <ul class="hidden md:flex flex-1 justify-center items-center gap-7 text-gray-50 text-base mr-5 font-sans">
        <button class=" bg-orange-500 text-white rounded p-2 font-sans text-xs">My Jobs</button>
        <input class=" placeholder:text-white bg-zinc-400 rounded-md text-white py-2 px-2 w-96 shadow-md text-xs" type="text" placeholder="Search...">
        <button class=" bg-orange-500 text-white rounded p-2 font-sans text-xs">All Category</button>
        <button class=" bg-orange-500 text-white rounded p-2 font-sans text-xs">Show Filters</button>
        <button class=" bg-orange-500 text-white rounded p-2 font-sans text-xs">Newest</button>              
    </ul>
    <div class="container-2xl md:flex flex-1 rounded-t-md py-4 mt-5 mx-48 bg-amber-200">
        <div>
            <p class="ml-5 font-sans text-xs text-black">1 - 20 of 200 Jobs</p>
        </div>
        <ul class="hidden md:flex flex-1 justify-end items-center gap-7 text-black text-xs text-base mr-5 font-sans">
            <li class="cursor-pointer hover:text-orange-500">Show 20 rows</li>
            <li class="cursor-pointer hover:text-orange-500">Prev</li>
