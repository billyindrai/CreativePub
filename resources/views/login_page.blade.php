...
<body class="antialiased bg-background">
    <header>    
        <nav class=" container flex items-center bg-background py-9 mx-auto">
            <!-- <div class=" w-52 ml-5 py-1">
            <img src="{{ asset('images/logo_cpub.png') }}" alt="logo creativePub">
        </div> -->
            <ul class="hidden md:flex flex-1 justify-end items-center text-base mr-12 font-sans ">
    ...
    <div class="cointainer md:flex flex-1 justify-center">
